    ...
    <div className="p-4">
        ...
        {projects.map((project) => (
          <li key={project.id} className="group relative">
            ...
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-1 opacity-0 group-hover:opacity-100 hover:bg-stone-200"
              title="Edit project"
            >
              <svg
      ...
      >
        <form onSubmit={handleCreateProject}>
          ...
          <button
            type="submit"
            className="mt-4 w-full rounded-md bg-emerald-600 px-4 py-2 text-white shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
          >
            Create
          </button>
        </form>
